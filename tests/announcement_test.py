...
def test_create_get_announcement(client: TestClient) -> None:
    ...
    announcement_create_response: AnnouncementCreate = (
        AnnouncementCreate.model_validate(response.json())
    )
    assert announcement_create_response.id == announcement_id
    assert announcement_create_response.title == "Test Announcement"
...
def test_create_announcement_date_before_deadline(client: TestClient) -> None:
    ...
    assert (
        ...
        == "Announcement date must be before announcement deadline."
    )
...
def test_delete_existing_announcement(client: TestClient) -> None:
    ...
    announcement: AnnouncementResponse = AnnouncementResponse.model_validate(
