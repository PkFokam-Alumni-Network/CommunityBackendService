...
class UpvoteService:
    ...
    def upvote_post(self, post_id: int, user_id: int, db: Session) -> Upvote:
    ...
    def remove_upvote_from_post(self, post_id: int, user_id: int, db: Session) -> None:
    ...
    def remove_upvote_from_comment(self, comment_id: int, user_id: int, db: Session) -> None:
